...
from dataset.CPDataset_HD import CPDataset
...
def main():
    args = OmegaConf.load('train_tryon.yaml')
    print(args)
    ...
    train_dataset = CPDataset(**train_data_config)
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                # concat
                concat_noisy_latents = torch.cat([noisy_latents, masked_image_embeds, pose_embeds], dim=1)
                ...
                model_pred = unet(
                    concat_noisy_latents, timesteps, encoder_hidden_states,
